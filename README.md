...
| 文件 | 作用 |
|---|---|
| `commandline-tools-linux-x64-26.0.0.621.zip` | 基础（完整版，含 hvigor/ohpm/hstack/codelinter/sdk） |
| `version-Daily_Version-OpenHarmony_7.0.0.38-...-ohos-sdk-public.tar.gz` | 5 个 linux 组件：ets/js/native/previewer/toolchains（26.0.0.38） |
| `node-v24.14.1-openharmony-arm64.tar.xz` | openharmony arm64 node，替换自带的 x86-64 node |
